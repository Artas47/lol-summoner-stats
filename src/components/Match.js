   ...
   championIdToName = (championId) => 
{
  ...
  render() {
    return (
      <div>
        {this.championIdToName(this.props.championId)}
        <img src={`https://opgg-static.akamaized.net/images/lol/champion/${this.championIdToName(this.props.championId)}.png?image=w_30&v=1`} />
      </div>
    )
  }
